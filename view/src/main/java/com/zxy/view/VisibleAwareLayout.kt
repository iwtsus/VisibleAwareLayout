...
open class VisibleAwareLayout : FrameLayout {
    ...
    private fun getVisibleState(): State {
    ...
    private fun handleListener() {
        post {
            val currentState = getVisibleState()
    ...
    fun visibleToUser(allExposure: Boolean = false): Boolean {
        return if (allExposure) {
            getVisibleState() == State.COMPLETELY_VISIBLE
        } else {
            getVisibleState() == State.COMPLETELY_VISIBLE || getVisibleState() == State.PARTIALLY_VISIBLE
        }
    }
